...
#define DEBUG 1
const char ssid[]     = "tjy";         // 使用时请修改为当前你的 wifi 名称 -- Please use your own wifi ssid
const char password[] = "12345678";     //  使用时请修改为当前你的 wifi 密码 -- Please use your own wifi password
const char OneNetServer[] = "api.heclouds.com";
const char APIKEY[] = "g=h3PiXCv6=OVxQSjPYvUjlHMIE=";    // 使用时请修改为你的API KEY -- Please use your own API KEY
int32_t DeviceId = 642907382;                             // 使用时请修改为你的设备ID -- Please use your own device ID
char DataStreams1[] = "Time";
